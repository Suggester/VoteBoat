...
module.exports = {
  ...
  do: async (message, client, args, Discord) => {
    const supporter = '569954188675776522'
    const upvoter = '640906114321612821'
    const supersup = '618893176295653397'
    // const beaner = '657644875499569161'
    ...
    const votes = client.stats.get(message.author.id, 'total')
